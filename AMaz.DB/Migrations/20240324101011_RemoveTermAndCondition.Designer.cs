...
namespace AMaz.DB.Migrations
{
    ...
    [Migration("20240324101011_RemoveTermAndCondition")]
    partial class RemoveTermAndCondition
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AMaz.Entity.File", b =>
                {
            ...
            modelBuilder.Entity("AMaz.Entity.File", b =>
                {
                    b.HasOne("AMaz.Entity.Contribution", "Contribution")
                        .WithMany("Files")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("AMaz.Entity.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
